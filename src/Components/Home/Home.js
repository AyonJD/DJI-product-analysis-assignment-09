...
const Home = () => {
    ...
    return (
        <>
            <div className='home-div flex flex-col md:flex-row justify-between items-center container mx-auto md:h-[90vh] h-auto'>
                <div className="left w-full md:w-1/2 order-2 md:order-1 px-4 md:px-0 md:mr-3">
